...
function SkillItem({ experience, name }: SkillItemProps) {
  return (
    <div className="w-full h-full flex items-end gap-2 p-2 lg:p-5">
      ...
      <div className="flex flex-col lg:items-start text-start">
        <p className="text-[12px] lg:text-sm lg:text-md font-semibold text-black/75">{name}</p>
        <p className="text-[12px] lg:text-sm text-black/50">months of experience</p>
      </div>
    </div>
  );
}
